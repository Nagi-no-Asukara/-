...
public class ShiroUtil {
    ...
    private static RedisManager redisManager=SpringUtil.getBean(RedisManager.class);
    private ShiroUtil() {
    }
    ...
    public static void getInfo(String sid){
        redisManager.getJedisPool().getResource().get(sid);
    }
